...
Route::post('/nearest-branch', [ctr\API\Resources\Branch\BranchC::class, 'nearest']);
Route::post('/distance-to', [ctr\API\Resources\Branch\BranchC::class, 'distanceToBranch']);
