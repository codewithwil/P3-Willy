...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6"><h3 class="mb-0">Informasi Pengguna/Pelanggan</h3></div>
            <div class="col-sm-6">
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="col-12 d-flex">
                        ...
                        <a href="{{ url('people/customer/create') }}" class="btn btn-primary ms-3 mt-3">
                            Tambah
                        </a>
                        <a href="{{ url('people/customer/invoice') }}" class="btn btn-warning ms-3 mt-3">
                            Invoice
                        </a>
                        @endif
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if(auth()->user()->hasRole(['admin', 'supervisor']) && auth()->user()->id !== $us->user_id)
                                            <form action="{{ url('people/customer/delete', $us->customerId) }}" method="POST" style="display: inline;">
                                                @csrf
                                                @method('POST') 
