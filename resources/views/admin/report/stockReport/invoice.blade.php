...
@section('title', 'Invoice Stok Transaksi')
...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6"><h3 class="mb-0">Invoice Stok Transaksi</h3></div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
                    <li class="breadcrumb-item">Transaksi</li>
                    <li class="breadcrumb-item">Pengajuan</li>
                    <li class="breadcrumb-item active" aria-current="page">Stok Transaksi</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div id="printableArea">
                            ...
                            <table id="dataTableStockReport" class="table table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Nama User</th>
...
@push('js')
    ...
    <script>
        new DataTable('#dataTableStockReport');
