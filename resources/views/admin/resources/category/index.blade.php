            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="col-12 d-flex">
                        ...
                        <a href="{{ url('configuration/category/create') }}" class="btn btn-primary ms-3 mt-3">
                            Tambah
                        </a>
                        <a href="{{ url('configuration/category/invoice') }}" class="btn btn-warning ms-3 mt-3">
                            Invoice
                        </a>
                        @endif
                        ...
                        <table id="dataTableCategory" class="table table-striped" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(auth()->user()->hasRole(['admin', 'supervisor', 'petugas']))
                                            <a href="{{ url('/configuration/category/edit/' . $cat->categoryId) }}" class="btn btn-primary">Edit</a>                                   
                                        @endif
                                        @if(auth()->user()->hasRole(['admin']))      
                                        <form action="{{ url('configuration/category/delete', $cat->categoryId) }}" method="POST" style="display: inline;">
                                            @csrf
                                            @method('POST') 
