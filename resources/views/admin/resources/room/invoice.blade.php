...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6"><h3 class="mb-0">Invoice Ruangan</h3></div>
            <div class="col-sm-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <div id="printableArea">
                            ...
                            <table id="dataTableRooms" class="table table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Gedung</th>
