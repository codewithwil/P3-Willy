...
@section('title', 'edit Data Servis Barang')
@section('content')

<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6"><h3 class="mb-0">Edit Data Servis Barang</h3></div>
            <div class="col-sm-6">
...
<div class="app-content">
    <div class="container-fluid">
        <div class="row">
            <form class="row g-3" action="{{ url('transactions/services/update/'.$services->serviceId) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card mb-4" style="border-left: 5px solid #007bff;">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="serviceCode">Kode Servis</label>
                                    <input type="text" name="" class="form-control" id="serviceCode" value="{{ $services->serviceCode }}" disabled>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="serviceDate">Tanggal Peminjaman</label>
                                    <input type="date" name="serviceDate" class="form-control" id="serviceDate" value="{{ $services->serviceDate }}" >
                                </div>
                                <div class="mb-3">
                                    <label for="note" class="form-label">Catatan</label>
                                    <textarea class="form-control" name="note" id="note" placeholder="Masukkan Catatan *(tidak wajib)" cols="30" rows="4">{{ $services->note }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="serviceName" class="form-control" id="serviceName" value="{{$services->serviceName}}" placeholder="Masukkan Nama Toko Servis">
                                        </div>  
                                        <div class="mb-3">
                                            <label for="servicePhone" class="form-label">Nomor Telepon Toko Service</label>
                                            <input type="number" name="servicePhone" class="form-control" id="servicePhone" value="{{$services->servicePhone}}" placeholder="Masukkan Nomor Telepon Toko Servis">
                                        </div>                              
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="serviceAddress" class="form-label">Alamat Toko</label>
                                            <textarea class="form-control" name="serviceAddress" id="serviceAddress" placeholder="Masukkan Alamat Toko Servis" cols="30" rows="4">{{$services->serviceAddress}}</textarea>
                                        </div>
                                    </div>
                                </div>
