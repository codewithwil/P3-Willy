...
<div class="app-content">
    <div class="container-fluid">
        <div class="row">
            <form class="row g-3" action="{{ url('transactions/services/store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="" class="form-control" id="serviceCode" value="{{ $serviceCode }}" disabled>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="serviceName" class="form-control" id="serviceName"  placeholder="Masukkan Nama Toko Servis">
                                        </div>  
                                        <div class="mb-3">
                                            <label for="servicePhone" class="form-label">Nomor Telepon Toko Service</label>
                                            <input type="number" name="servicePhone" class="form-control" id="servicePhone"  placeholder="Masukkan Nomor Telepon Toko Servis">
                                        </div>                              
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="serviceAddress" class="form-label">Alamat Toko</label>
                                            <textarea class="form-control" name="serviceAddress" id="serviceAddress" placeholder="Masukkan Alamat Toko Servis" cols="30" rows="4"></textarea>
                                        </div>
                                    </div>
                                </div>
