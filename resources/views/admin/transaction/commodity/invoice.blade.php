...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6"><h3 class="mb-0">Invoice Barang</h3></div>
            <div class="col-sm-6">
                            ...
                            <table id="dataTableUser" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr class="{{ $com->stock->sum('quantity') == 0 ? 'table-danger' : '' }}">
                                        ...
                                        <td>{{ $com->name }}</td>
                                        <td>{{ $com->category ? $com->category->name : 'category not set' }}</td>
                                        <td>{{ $com->room ? $com->room->roomName : 'room not set' }} | lt{{ $com->room ? $com->room->floor : 'floor not set' }}</td>
                                        <td>{{ $com->typeText ?? 'tipe barang belum di atur' }}</td>
                                        <td>{{ $com->merk ?? 'merk  barang belum di atur' }}</td>
                                        <td>
