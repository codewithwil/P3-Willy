...
@section('title', 'Invoice Peminjaman')
...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6"><h3 class="mb-0">Invoice Peminjaman</h3></div>
            <div class="col-sm-6">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @elseif($loan->statusLoan == \App\Models\Transactions\Loaning\Loaning::STATUS_DIAJUKAN)
                                            <span class="text-warning">Diajukan</span>
                                            @else
