...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6"><h3 class="mb-0">Tambah Data Peminjaman</h3></div>
            <div class="col-sm-6">
...
<div class="app-content">
    <div class="container-fluid">
        <div class="row">
            <form class="row g-3" action="{{ url('transactions/loanings/store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="" class="form-control" id="itemCode" value="{{ $itemCode }}" disabled>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="loanDate" class="form-control" id="loanDate" placeholder="Masukkan Tanggal Peminjaman">
                                </div>
                                <div class="mb-3">
